...
<div class="top-line">
    <div class="container flex-center">
        <div class="top-line__main flex-center">
            ...
            <div class="top-line-time flex-center"> <span class="top-line-time__text"> Пн-Пт: <span>C 9:00 - 17:00</span></span></div>
        </div>
...
<nav class="main-menu">
    ...
    <div class="list-cat">
        ...
        <ul class="list-cat__list">
            <li class="list-cat__list-item"><a href="#" class="list-cat__list-link">Комоды и Тумбы</a></li>
            <li class="list-cat__list-item"><a href="#" class="list-cat__list-link">Мебель для детей</a></li>
            <li class="list-cat__list-item"><a href="#" class="list-cat__list-link">Прихожие</a></li>
            <li class="list-cat__list-item"><a href="#" class="list-cat__list-link">Стенки для гостиней</a></li>
